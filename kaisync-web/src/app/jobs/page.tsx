  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6"
      ...
      <div className="w-16 h-16 rounded-2xl flex items-center justify-center mb-6"
        ...
        <span className="material-icons text-white text-[32px]">work_outline</span>
      </div>
      <h1 className="text-white text-[28px] font-bold mb-3">Job Portal</h1>
      <p className="text-slate-400 text-[15px] text-center max-w-[340px] mb-8">
        Browse open positions and submit applications.
      </p>
