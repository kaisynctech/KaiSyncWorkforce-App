...
window.KAIFLOW_CONFIG = {
    ...
    webAppUrl: 'https://kaisync-app.vercel.app/',
    productName: 'KaiFlow',
    ...
    fallbackDownloads: {
        windows: 'https://github.com/kaisynctech/KaiSync-App/releases/latest',
        android: 'https://github.com/kaisynctech/KaiSync-App/releases/latest'
    }
};
