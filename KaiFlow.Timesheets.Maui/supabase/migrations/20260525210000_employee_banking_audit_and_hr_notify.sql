-- Banking audit trail + HR notifications when employees update bank details.
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE conname = 'employees_bank_details_updated_by_chk'
      AND conrelid = 'public.employees'::regclass
  ) THEN
    ALTER TABLE public.employees
      ADD CONSTRAINT employees_bank_details_updated_by_chk
